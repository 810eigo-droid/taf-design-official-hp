...
記事06「会員サイトを作る前に決めたい5つのこと」のHTML・画像2枚・WP設定・投稿手順を保存。公開は未確認。重複防止の一覧は [ブログ記事台帳](docs/blog-posts/README.md)。同じ番号の下書き・noteは別テーマとして数えない。
...
- [x] ブログ06の投稿セットと記事台帳を作成（2026-09-26）
- [ ] ブログ06をWPで公開し、実URL・画像URL・日時を記事台帳と原稿へ反映
- [ ] ブログ06の公開後SEO・構造化データ・Search Console確認
