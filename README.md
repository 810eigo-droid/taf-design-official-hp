...
| 資料 /lp/service-guide.html | 公開中=v27。**リポジトリ=v35**(GA4タグ設置+価格2万円税込)。Xserverアップ待ち | 🔄 lp/service-guide.html をアップすれば完了 |
...
4. 確認: 資料ページの表紙下部に **「v35」** が見えたら反映成功
...
- `service-guide.html` は変更のたびにフッターのバージョン印を上げる(反映確認用。原稿=v35)
