...
| 資料 /lp/service-guide.html | 公開中=v27。**リポジトリ=v43**(キャッチコピー統一「ぜんぶ、一社で。」+対象を企業まで拡大)。Xserverアップ待ち | 🔄 lp/service-guide.html をアップすれば完了 |
...
4. 確認: 資料ページの表紙下部に **「v43」** が見えたら反映成功
...
- `service-guide.html` は変更のたびにフッターのバージョン印を上げる(反映確認用。原稿=v43)
