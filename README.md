...
| 資料 /lp/service-guide.html | 公開中=v27。**リポジトリ=v37**(基本プラン価格を¥20,000固定表記に)。Xserverアップ待ち | 🔄 lp/service-guide.html をアップすれば完了 |
...
4. 確認: 資料ページの表紙下部に **「v37」** が見えたら反映成功
...
- `service-guide.html` は変更のたびにフッターのバージョン印を上げる(反映確認用。原稿=v37)
