...
> 作成: 2026-08-04 / index.html のWORKSセクション(.works-grid)の各カードのリンク先を管理
> ルール: 外部サイトは新しいタブで開く(target="_blank" rel="noopener noreferrer")。
>        リンクなしのカードは従来どおりクリックで拡大表示(ライトボックス)。
> 画像: images/work-NN.jpg(既存01〜08)。09以降は追加が必要。
> ※「名称」列はオーナー用の備忘録。サイト上には表示しない。

## 一覧

| # | 名称(備忘録・非表示) | リンク先 | 画像 | 状態 |
|---|---|---|---|---|
| 01 | 呉服福岡 | https://gofukuno-yokoo.com/kimono-care-event-fukuoka/ | work-01.jpg | ✅ 反映済み |
| 02 | 制作会社LP | https://demo1129.my.canva.site/dahihgbbow0 | work-02.jpg | ✅ 反映済み |
| 03 | アイスパ | https://eyespa-academy.com/lp/ | work-03.jpg | ✅ 反映済み |
| 04 | 大学武道部 | https://swell.810eigo.com/ | work-04.jpg | ✅ 反映済み |
| 05 | パーソナルジム | https://demo1129.my.canva.site/dag9rvyobwg | work-05.jpg | ✅ 反映済み(2026-08-04 URL変更・旧swell.810eigo.com) |
...
- 09〜14の画像(work-09.jpg〜work-14.jpg 相当)をGitに入れ次第、カードを追加してリンク設定する
  ※オーナー:画像は準備済み。サーバーには上げる/Gitには後で入れる予定
